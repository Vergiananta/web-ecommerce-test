...
function BedRoomDesign(props) {
    ...
    const getDataRoom=async ()=>{
        await getRoomByName("Living Room").then((response)=>{
    ...
    return (
        <>
            ...
            >
                <Container>
                    <h2 className={classes.header}>Living Room Design Interior</h2>
                    {
                        designsCard()
                    }
