...
function BedRoomDesign(props) {
    ...
    const getDataRoom = async () => {
        await getRoomByName("Bed Room").then((response) => {
                                                ...
                                                <Card className={classes.root}>
                                                    ...
                                                    <CardActions>
                                                        <IconButton aria-label="add to favorites" key={index}
                                                                    onClick={() => setCountLove(countLove + 1)}>
    ...
    return (
        <>
            ...
            >
                <Container>
                    <h2 className={classes.header}>Bed Room Design Interior</h2>
                    {
                        designsCard()
                    }
...
function mapDispatchToProps(dispatch) {
    return {
        ...
        handleInputTrx: (inputNameTrx, inputValueTrx) => dispatch({
            type: HANDLE_CHANGES_TRANSACTION,
            payload: {inputNameTrx, inputValueTrx}
        }),
...
export default connect(mapStateToProps, mapDispatchToProps)(withRouter(BedRoomDesign));
